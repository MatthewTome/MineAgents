...
export class HuggingFacePlanner {
    ...
    buildPrompt(request, knowledge = []) {
        ...
        return [
            ...
            knowledgeSection,
            "CRITICAL RULES:",
            "1. For multi-part builds (house, base), you MUST pick a specific coordinate (e.g. x:100, y:64, z:100) and use it as the 'origin' for EVERY build step (platform, walls, roof). Do NOT omit the origin.",
            "2. Prefer 1-8 steps. Be complete (include roof, door).",
